...
import classes from '../styles/AccessManageTeamModal.module.css';

const AccessManageTeamModal = ({active, setActive, team, title}) => {
        ...
        <Modal active={active} setActive={setActive}>
            <div className={classes.wrapper}>
                ...
                <div className={classes.teamDescription}>
                    ...
                    <span className={classes.teamRole}>//&nbsp;{team.description}</span> 
                </div>
...
export default AccessManageTeamModal;